...
// Measured from the origin, never from the previous deadline: adding a
// period each time lets one slow step push every later one out, and the
// run drifts late without ever reporting it.
